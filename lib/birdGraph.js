...
export const NODES = {
  ...
  n28: [329.7, 325.9],
  n29: [61.4, 329.0],
  // Beak tip: a line-convergence point in the source image, not a marked
  // dot — added by hand since blob detection only finds filled circles.
  n30: [469, 98],
};

// Nodes with no visible dot in the reference (currently just the beak tip).
export const NO_DOT = new Set(["n30"]);
...
export const TRIANGLES = [
  ...
  // beak point (hand-added, see NODES.n30)
  ["n4", "n6", "n30"],
  ["n6", "n9", "n30"],
];
